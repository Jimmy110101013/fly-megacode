...
export const INK = '#dce5ee';
export const MUTED = '#7c8da0';
const AMBER = '#f0a93b';
export const PAM = '#3bb0f0';
export const PPL1 = '#ff4d6d';
const LINE = '#1c2530';
...
export const label = (ctx, text, x, y) => {
  ctx.fillStyle = MUTED;
...
export class BrainView {
  ...
  _curve(history) {
    ...
    // Re-measured at 12.3% after the generator fix: the old figure was taken on
    // scenarios that were VF and PEA only. See "Retracted" in the README.
    const chance = 0.123;
    ...
    ctx.fillText('chance 12.3%', pad + 2, y(chance) - 4);
